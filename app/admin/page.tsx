      ...
      <div className={styles.grid}>
        ...
        <section className={styles.card}>
          ...
          <div className={styles.formGrid}>
            <label className={styles.label}>
              Nome do produto
              <input className={styles.input} value={productName} onChange={(e) => setProductName(e.target.value)} placeholder="Ex: Camiseta Lisa Premium" />
            </label>

            <label className={styles.label}>
              SKU do pai
              <div className={styles.skuRow}>
                <input className={styles.input} value={parentSku} onChange={(e) => setParentSku(e.target.value)} placeholder="SKU automático (ou clique em Gerar próximo)" />
