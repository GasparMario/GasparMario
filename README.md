...
- Atributos Woo no CSV usam nomes globais **Cor** e **Tamanho** (em vez de `pa_cor`/`pa_tamanho`), com colunas `Attribute X visible` e `Attribute X global` preenchidas com `1`.
